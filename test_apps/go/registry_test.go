...
// alef:hash:cb2d6797a0b9551c654858e55f062338b9cee59230843eebb8ff651f2164708b
...
func Test_GetLanguageUnknown(t *testing.T) {
	...
	err := tspack.GetLanguage(`nonexistent_xyz`)
	if err == nil {
...
func Test_GetParserUnknown(t *testing.T) {
	...
	err := tspack.GetParser(`nonexistent_xyz`)
	if err == nil {
		t.Errorf("expected an error, but call succeeded")
	}
}
