...
dependencies {
    ...
    implementation("dev.kreuzberg.tslp.android:tree-sitter-language-pack-android:1.9.0-rc.30")
...
tasks.register("verifyAarPublished") {
    ...
    doLast {
        val aarCoord = "dev.kreuzberg.tslp.android:tree-sitter-language-pack-android:1.9.0-rc.30"
