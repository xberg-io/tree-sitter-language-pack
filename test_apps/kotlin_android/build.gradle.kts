...
dependencies {
    ...
    implementation("io.xberg.tslp.android:tree-sitter-language-pack-android:1.19.0")
...
tasks.register("verifyAarPublished") {
    ...
    doLast {
        val aarCoord = "io.xberg.tslp.android:tree-sitter-language-pack-android:1.19.0"
