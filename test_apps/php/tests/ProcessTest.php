...
// alef:hash:324756f510f05509f71699f4c24ab52056be9d2b6b0f88de06b636df38a63cad
...
final class ProcessTest extends TestCase
{
    ...
    public function test_java_class_process(): void
    {
        ...
        $structure = $result->getStructure();
            ...
            $this->assertGreaterThanOrEqual(1, count($structure));
        $this->assertTrue((bool)array_filter($result->getStructure(), fn($e) => str_contains((string)$e->getKind()->type_tag, "Class")));
            $this->assertGreaterThanOrEqual(1, count($imports));
            $this->assertGreaterThanOrEqual(7, $result->getMetrics()->totalLines);
            $this->assertEquals(0, $result->getMetrics()->errorCount);
    ...
    public function test_java_package_declaration_process(): void
    {
        ...
        $this->assertTrue((bool)array_filter($result->getStructure(), fn($e) => str_contains((string)$e->getKind()->type_tag, "Module")));
        $this->assertTrue((bool)array_filter($result->getStructure(), fn($e) => str_contains((string)$e->getKind()->type_tag, "Class")));
            $this->assertEquals(0, $result->getMetrics()->errorCount);
    ...
    public function test_process_javascript_exports_count(): void
    {
        ...
        $exports = $result->getExports();
            ...
            $this->assertEquals("javascript", $result->language);
            $this->assertGreaterThanOrEqual(2, count($exports));
    ...
    public function test_process_python_imports_detail(): void
    {
        ...
        $imports = $result->getImports();
            ...
            $this->assertEquals("python", $result->language);
            $this->assertGreaterThanOrEqual(2, count($imports));
        $this->assertTrue((bool)array_filter($result->getImports(), fn($e) => str_contains((string)$e->source, "os")));
    ...
    public function test_process_python_symbols(): void
    {
        ...
        $symbols = $result->getSymbols();
            ...
            $this->assertEquals("python", $result->language);
            $this->assertGreaterThanOrEqual(1, count($symbols));
    ...
    public function test_python_error_diagnostics(): void
    {
        ...
        $diagnostics = $result->getDiagnostics();
            ...
            $this->assertGreaterThan(0, count($diagnostics ?? []), 'expected non-empty value');
