...
import { process, getFoldsQuery, getHighlightsQuery, getIndentsQuery, getInjectionsQuery, getLocalsQuery, getTagsQuery } from "@xberg-io/tree-sitter-language-pack";
