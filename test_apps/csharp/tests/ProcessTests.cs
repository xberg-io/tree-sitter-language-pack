...
// alef:hash:ccff72ea47dfed2ecc8a9e1515b2c43839ba4e4a8a4d1cfc077bbc8f7ec84c72
...
namespace TreeSitterLanguagePack
{
    ...
    public class ProcessTests
    {
        ...
        public void Test_CFunctionProcess()
        {
            ...
            Assert.True(result.Structure?.Any(e767d0b15 => e767d0b15.Kind is { } && System.Text.Json.JsonSerializer.Serialize(e767d0b15.Kind, new System.Text.Json.JsonSerializerOptions { Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping }).Trim('"').Contains("Function")) == true, "element of 'structure[].kind': Function");
        ...
        public void Test_JavaClassProcess()
        {
            ...
            Assert.True(result.Structure.Count >= 1, "expected at least 1 elements");
            Assert.True(result.Structure?.Any(ee876d34e => ee876d34e.Kind is { } && System.Text.Json.JsonSerializer.Serialize(ee876d34e.Kind, new System.Text.Json.JsonSerializerOptions { Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping }).Trim('"').Contains("Class")) == true, "element of 'structure[].kind': Class");
            Assert.True(result.Imports.Count >= 1, "expected at least 1 elements");
            Assert.True(result.Metrics.TotalLines >= 7, "expected >= 7");
            Assert.True(result.Metrics.ErrorCount == 0);
        ...
        public void Test_JavaPackageDeclarationProcess()
        {
            ...
            Assert.True(result.Structure?.Any(e66a77f4c => e66a77f4c.Kind is { } && System.Text.Json.JsonSerializer.Serialize(e66a77f4c.Kind, new System.Text.Json.JsonSerializerOptions { Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping }).Trim('"').Contains("Module")) == true, "element of 'structure[].kind': Module");
            Assert.True(result.Structure?.Any(ee876d34e => ee876d34e.Kind is { } && System.Text.Json.JsonSerializer.Serialize(ee876d34e.Kind, new System.Text.Json.JsonSerializerOptions { Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping }).Trim('"').Contains("Class")) == true, "element of 'structure[].kind': Class");
            Assert.True(result.Metrics.ErrorCount == 0);
        ...
        public void Test_KotlinPackageClassProcess()
        {
            ...
            Assert.Equal("kotlin", result.Language);
            Assert.True(result.Structure.Count >= 2, "expected at least 2 elements");
            Assert.True(result.Structure?.Any(e66a77f4c => e66a77f4c.Kind is { } && System.Text.Json.JsonSerializer.Serialize(e66a77f4c.Kind, new System.Text.Json.JsonSerializerOptions { Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping }).Trim('"').Contains("Module")) == true, "element of 'structure[].kind': Module");
            Assert.True(result.Structure?.Any(ee876d34e => ee876d34e.Kind is { } && System.Text.Json.JsonSerializer.Serialize(ee876d34e.Kind, new System.Text.Json.JsonSerializerOptions { Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping }).Trim('"').Contains("Class")) == true, "element of 'structure[].kind': Class");
            Assert.True(result.Metrics.ErrorCount == 0);
        ...
        public void Test_ProcessPythonImportsDetail()
        {
            ...
            Assert.Equal("python", result.Language);
            Assert.True(result.Imports.Count >= 2, "expected at least 2 elements");
            Assert.True(result.Imports?.Any(e178012aa => Convert.ToString(e178012aa.Source)!.Contains("os")) == true, "element of 'imports[].source': os");
        ...
        public void Test_ProcessRustStructureName()
        {
            ...
            Assert.True(result.Structure.Count >= 1, "expected at least 1 elements");
            Assert.Contains("MyConfig", JsonSerializer.Serialize(result.Structure));
