...
// alef:hash:d41ab088d8f8887e169b4b68d686cd620a1276b0aaab09901a57aa5ff0c3bf8e
...
func lastError() error {
	...
	var message string
	if ctx := C.ts_pack_last_error_context(); ctx != nil {
		message = C.GoString(ctx)
	}
	var sentinel error
	switch code {
	case 100:
		sentinel = ErrLanguageNotFound
	case 101:
		sentinel = ErrDynamicLoad
	case 102:
		sentinel = ErrNullLanguagePointer
	case 103:
		sentinel = ErrParserSetup
	case 104:
	...
	case 107:
		sentinel = ErrParseTimeout
	case 108:
		sentinel = ErrQueryError
	case 109:
		sentinel = ErrInvalidRange
	case 110:
		sentinel = ErrDownload
	case 111:
		sentinel = ErrChecksumMismatch
	case 112:
		sentinel = ErrCacheLock
	}
	if sentinel != nil {
		if message == "" {
			return sentinel
