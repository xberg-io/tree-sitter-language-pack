...
// alef:hash:9b09c5357fd985ae9488232ee9c3e04a5aed4b192511a410f320d183b2f3a1b4
...
public record CommentInfo(String text, CommentKind kind, Span span,
        @Nullable @JsonProperty("associatedNode") @JsonAlias("associated_node") String associatedNode) {
