...
// alef:hash:18060842318fe51176087f53e359a01f3ffa41eeaf42b3c4147b0b3cd02c7a02
...
public final class TreeSitterLanguagePackRs {
    ...
    public static Tree parseString(final String language, final byte[] source)
        ...
        try (var arena = Arena.ofConfined()) {
            ...
            var resultPtr = (MemorySegment) NativeLib.TS_PACK_PARSE_STRING.invoke(clanguage, source);
            if (resultPtr.equals(MemorySegment.NULL)) {
                checkLastError();
                return null;
            }
            return new Tree(resultPtr);
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    }
