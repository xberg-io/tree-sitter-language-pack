...
public final class TreeSitterLanguagePackRs {
   ...
   */
  public static Optional<String> getIndentsQuery(final String language)
      throws TreeSitterLanguagePackRsException {
    try (var arena = Arena.ofShared()) {
      var clanguage = arena.allocateFrom(language);
   ...
   */
  public static Optional<String> getFoldsQuery(final String language)
      throws TreeSitterLanguagePackRsException {
    try (var arena = Arena.ofShared()) {
      var clanguage = arena.allocateFrom(language);
   ...
   */
  public static void prefetch(final List<String> languages)
      throws TreeSitterLanguagePackRsException {
    try (var arena = Arena.ofShared()) {
      var clanguagesJson = MAPPER
          .writerFor(
              MAPPER.getTypeFactory().constructCollectionType(java.util.List.class, String.class))
          .writeValueAsString(languages);
