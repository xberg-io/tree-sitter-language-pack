...
// alef:hash:ef7e051fba96fb74b1e5917892246b3e9baf1dde2a911604b2a420a5b42ab648
...
mod ffi {
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "parserSetMaxSourceBytes")]
        fn parser_set_max_source_bytes(client: &mut Parser, max_bytes: Option<usize>) -> ();
        #[swift_bridge(swift_name = "parserSetParseTimeoutMs")]
        fn parser_set_parse_timeout_ms(client: &mut Parser, timeout_ms: Option<u64>) -> ();
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "maxSourceBytes")]
        fn max_source_bytes(&self) -> Option<usize>;
        #[swift_bridge(swift_name = "parseTimeoutMs")]
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "processConfigWithMaxSourceBytesFromJson")]
        fn process_config_with_max_source_bytes_from_json(
            json: String,
            max_bytes: Option<usize>,
        ) -> Result<String, String>;
        #[swift_bridge(swift_name = "processConfigWithParseTimeoutMsFromJson")]
        fn process_config_with_parse_timeout_ms_from_json(
            json: String,
            timeout_ms: Option<u64>,
        ) -> Result<String, String>;
        #[swift_bridge(swift_name = "processConfigValidateFromJson")]
        fn process_config_validate_from_json(json: String) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "manifestGroups")]
        fn manifest_groups() -> Result<Vec<String>, String>;
...
pub fn parser_set_max_source_bytes(client: &mut Parser, max_bytes: Option<usize>) {
    client.0.set_max_source_bytes(max_bytes)
}
pub fn parser_set_parse_timeout_ms(client: &mut Parser, timeout_ms: Option<u64>) {
    client.0.set_parse_timeout_ms(timeout_ms)
}
...
impl ProcessConfig {
    pub fn new(
        ...
        __target.max_source_bytes = max_source_bytes;
        __target.parse_timeout_ms = parse_timeout_ms;
    ...
    pub fn max_source_bytes(&self) -> Option<usize> {
        self.0.max_source_bytes.as_ref().and_then(|v| {
            ::serde_json::to_value(v)
                .ok()
                .and_then(|j| ::serde_json::from_value(j).ok())
        })
    ...
    pub fn parse_timeout_ms(&self) -> Option<u64> {
        self.0.parse_timeout_ms.as_ref().and_then(|v| {
            ::serde_json::to_value(v)
                .ok()
                .and_then(|j| ::serde_json::from_value(j).ok())
        })
...
pub fn process_config_with_max_source_bytes_from_json(
    json: String,
    max_bytes: Option<usize>,
) -> Result<String, String> {
    let __self: tree_sitter_language_pack::ProcessConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProcessConfig: {}", e))?;
    let __result = __self.with_max_source_bytes(max_bytes);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn process_config_with_parse_timeout_ms_from_json(json: String, timeout_ms: Option<u64>) -> Result<String, String> {
    let __self: tree_sitter_language_pack::ProcessConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProcessConfig: {}", e))?;
    let __result = __self.with_parse_timeout_ms(timeout_ms);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn process_config_validate_from_json(json: String) -> Result<String, String> {
    let __self: tree_sitter_language_pack::ProcessConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProcessConfig: {}", e))?;
...
#[allow(dead_code)]
fn __alef_comment_kind_from_swift_string(value: &str) -> Result<tree_sitter_language_pack::CommentKind, String> {
    match value {
        "Line" => Ok(tree_sitter_language_pack::CommentKind::Line),
        "Block" => Ok(tree_sitter_language_pack::CommentKind::Block),
        "Doc" => Ok(tree_sitter_language_pack::CommentKind::Doc),
        _ => Err(format!("unknown CommentKind variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_data_node_kind_from_swift_string(value: &str) -> Result<tree_sitter_language_pack::DataNodeKind, String> {
    match value {
        "KeyValue" => Ok(tree_sitter_language_pack::DataNodeKind::KeyValue),
        "Element" => Ok(tree_sitter_language_pack::DataNodeKind::Element),
        "Sequence" => Ok(tree_sitter_language_pack::DataNodeKind::Sequence),
        _ => Err(format!("unknown DataNodeKind variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_diagnostic_severity_from_swift_string(
    value: &str,
) -> Result<tree_sitter_language_pack::DiagnosticSeverity, String> {
    match value {
        "Error" => Ok(tree_sitter_language_pack::DiagnosticSeverity::Error),
        "Warning" => Ok(tree_sitter_language_pack::DiagnosticSeverity::Warning),
        "Info" => Ok(tree_sitter_language_pack::DiagnosticSeverity::Info),
        _ => Err(format!("unknown DiagnosticSeverity variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_export_kind_from_swift_string(value: &str) -> Result<tree_sitter_language_pack::ExportKind, String> {
    match value {
        "Named" => Ok(tree_sitter_language_pack::ExportKind::Named),
        "Default" => Ok(tree_sitter_language_pack::ExportKind::Default),
        "ReExport" => Ok(tree_sitter_language_pack::ExportKind::ReExport),
        _ => Err(format!("unknown ExportKind variant: {:?}", value)),
    }
}
