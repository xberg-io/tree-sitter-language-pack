...
// alef:hash:053a70f87e657000f4c70fe26ffcf748610f8590f93f55940c846c38464cf8fd
...
public enum DocstringFormat: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "Other":
            self = .other(field0: try container.decode(String.self, forKey: key))
        default:
            throw DecodingError.dataCorrupted(
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .pythonTripleQuote:
            ...
            try single.encode("PythonTripleQuote")
        case .jsDoc:
            var single = encoder.singleValueContainer()
            try single.encode("JSDoc")
        case .rustdoc:
            var single = encoder.singleValueContainer()
            try single.encode("Rustdoc")
        case .goDoc:
            var single = encoder.singleValueContainer()
            try single.encode("GoDoc")
        case .javaDoc:
            var single = encoder.singleValueContainer()
            try single.encode("JavaDoc")
        case .other(let value):
            var container = encoder.container(keyedBy: __AlefExternalTagKey.self)
            try container.encode(value, forKey: __AlefExternalTagKey("Other"))
        }
    }
}
...
public enum StructureKind: Codable, Sendable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .function:
            var single = encoder.singleValueContainer()
            try single.encode("Function")
        case .method:
            var single = encoder.singleValueContainer()
            try single.encode("Method")
        case .`class`:
            var single = encoder.singleValueContainer()
            try single.encode("Class")
        case .`struct`:
            var single = encoder.singleValueContainer()
            try single.encode("Struct")
        case .interface:
            var single = encoder.singleValueContainer()
            try single.encode("Interface")
        case .`enum`:
            var single = encoder.singleValueContainer()
            try single.encode("Enum")
        case .module:
            var single = encoder.singleValueContainer()
            try single.encode("Module")
        case .trait:
            var single = encoder.singleValueContainer()
            try single.encode("Trait")
        case .impl:
            var single = encoder.singleValueContainer()
            try single.encode("Impl")
        case .namespace:
            var single = encoder.singleValueContainer()
            try single.encode("Namespace")
        case .other(let value):
            var container = encoder.container(keyedBy: __AlefExternalTagKey.self)
            try container.encode(value, forKey: __AlefExternalTagKey("Other"))
        }
...
public enum SymbolKind: Codable, Sendable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .variable:
            var single = encoder.singleValueContainer()
            try single.encode("Variable")
        case .constant:
            var single = encoder.singleValueContainer()
            try single.encode("Constant")
        case .function:
            var single = encoder.singleValueContainer()
            try single.encode("Function")
        case .`class`:
