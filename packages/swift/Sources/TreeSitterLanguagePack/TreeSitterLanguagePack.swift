...
public enum StructureKind: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "Namespace":
            self = .namespace
        case "Other":
            self = .other(value: try container.decode(String.self, forKey: .value))
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .kind,
                in: container,
                debugDescription: "Unknown StructureKind type: \(type)"
            )
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .method:
            try container.encode("Method", forKey: .kind)
        case .`class`:
            try container.encode("Class", forKey: .kind)
        case .`struct`:
            try container.encode("Struct", forKey: .kind)
        case .interface:
            try container.encode("Interface", forKey: .kind)
        case .`enum`:
            try container.encode("Enum", forKey: .kind)
        case .module:
            try container.encode("Module", forKey: .kind)
        case .trait:
            try container.encode("Trait", forKey: .kind)
        case .impl:
            try container.encode("Impl", forKey: .kind)
        case .namespace:
            try container.encode("Namespace", forKey: .kind)
...
public enum DocstringFormat: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .kind,
                in: container,
                debugDescription: "Unknown DocstringFormat type: \(type)"
            )
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .pythonTripleQuote:
            try container.encode("PythonTripleQuote", forKey: .kind)
        case .jsDoc:
            try container.encode("JSDoc", forKey: .kind)
        case .rustdoc:
            try container.encode("Rustdoc", forKey: .kind)
        case .goDoc:
            try container.encode("GoDoc", forKey: .kind)
        case .javaDoc:
            try container.encode("JavaDoc", forKey: .kind)
        case .other(let value):
            try container.encode("Other", forKey: .kind)
            try container.encode(value, forKey: .value)
...
public enum SymbolKind: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .kind,
                in: container,
                debugDescription: "Unknown SymbolKind type: \(type)"
            )
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .variable:
            try container.encode("Variable", forKey: .kind)
        case .constant:
