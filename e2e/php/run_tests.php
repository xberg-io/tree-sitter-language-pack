...
// alef:hash:3cf51a22539da7f99bd5b8fce335836058c4924ca99c38eba480ac1dc094135d
...
if (!$pieInstalledExtPath) {
    ...
    if ($registryExtDir !== '') {
        $pieInstalledExtPath = $registryExtDir . '/tree_sitter_language_pack.so';
    }
}
...
if ($loadedVersion !== '1.20.0') {
    ...
    fwrite(STDERR, "  expected version: 1.20.0\n");
