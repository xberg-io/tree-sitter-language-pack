...
# alef:hash:ab22515abbce55ffb98447e8c8a161337052ce7387b0ccb5ddcb6c5d35c12343
...
@pytest.mark.skip(reason="Requires c language")
...
@pytest.mark.skip(reason="Requires python language")
...
@pytest.mark.skip(reason="Requires go language")
...
@pytest.mark.skip(reason="Requires java language")
...
def test_java_package_declaration_process() -> None:
    ...
    assert "Module" in result.structure_kinds  # noqa: S101
    assert "Class" in result.structure_kinds  # noqa: S101
    assert result.metrics.error_count == 0  # noqa: S101


@pytest.mark.skip(reason="Requires javascript language")
...
@pytest.mark.skip(reason="Requires kotlin language")
...
def test_python_chunking_medium() -> None:
    ...
    assert result.max_chunk_size <= 50  # noqa: S101
...
def test_python_chunking_process_detail() -> None:
    ...
    assert len(result.chunks) >= 2  # noqa: S101
    assert result.max_chunk_size <= 30  # noqa: S101
...
@pytest.mark.skip(reason="Requires ruby language")
...
@pytest.mark.skip(reason="Requires rust language")
...
@pytest.mark.skip(reason="Requires typescript language")
