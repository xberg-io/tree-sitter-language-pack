...
tree-sitter-language-pack bundles 300+ tree-sitter parsers with code intelligence and chunking. It's part of the Kreuzberg family — a set of open-source tools from the same team, each built on a fast Rust core. Explore the related projects:
