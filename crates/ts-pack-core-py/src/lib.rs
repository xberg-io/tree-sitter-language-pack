...
// alef:hash:ee2e2dd21e9856344c7c8028e04912339335371e48aaceaa83ebe2d263dbf0a8
...
impl StructureItem {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (kind=Self::default().kind, span=Self::default().span, children=Self::default().children, decorators=Self::default().decorators, name=None, visibility=None, doc_comment=None, signature=None, body_span=None))]
    #[new]
    pub fn new(
        kind: StructureKind,
        span: Span,
...
impl CommentInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (text=Self::default().text, kind=Self::default().kind, span=Self::default().span, associated_node=None))]
    #[new]
...
impl DocstringInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (text=Self::default().text, format=Self::default().format, span=Self::default().span, parsed_sections=Self::default().parsed_sections, associated_item=None))]
    #[new]
    pub fn new(
        text: String,
...
impl ImportInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (source=Self::default().source, items=Self::default().items, is_wildcard=Self::default().is_wildcard, span=Self::default().span, alias=None))]
    #[new]
...
impl ExportInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (name=Self::default().name, kind=Self::default().kind, span=Self::default().span))]
    #[new]
...
impl SymbolInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (name=Self::default().name, kind=Self::default().kind, span=Self::default().span, type_annotation=None, doc=None))]
    #[new]
    pub fn new(
        name: String,
        kind: SymbolKind,
...
impl Diagnostic {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (message=Self::default().message, severity=Self::default().severity, span=Self::default().span))]
    #[new]
...
impl CodeChunk {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (content=Self::default().content, start_byte=Self::default().start_byte, end_byte=Self::default().end_byte, start_line=Self::default().start_line, end_line=Self::default().end_line, metadata=Self::default().metadata))]
    #[new]
    pub fn new(
        content: String,
        start_byte: usize,
