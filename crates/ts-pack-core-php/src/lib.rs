...
impl DocstringInfo {
    ...
    #[php(constructor)]
    pub fn new(text: String, associatedItem: Option<String>) -> Self {
        Self {
            text,
...
impl SymbolInfo {
    ...
    #[php(constructor)]
    pub fn new(name: String, typeAnnotation: Option<String>, doc: Option<String>) -> Self {
        Self {
            name,
            kind: Default::default(),
            span: Default::default(),
...
impl From<StructureKind> for tree_sitter_language_pack::StructureKind {
    fn from(val: StructureKind) -> Self {
        match val.kind_tag.as_str() {
            ...
            "Other" => tree_sitter_language_pack::StructureKind::Other {
...
impl From<DocstringFormat> for tree_sitter_language_pack::DocstringFormat {
    fn from(val: DocstringFormat) -> Self {
        match val.kind_tag.as_str() {
            ...
            "Other" => tree_sitter_language_pack::DocstringFormat::Other {
                value: val.value.unwrap_or_default(),
            },
...
impl From<SymbolKind> for tree_sitter_language_pack::SymbolKind {
    fn from(val: SymbolKind) -> Self {
        match val.kind_tag.as_str() {
            ...
            "Other" => tree_sitter_language_pack::SymbolKind::Other {
                value: val.value.unwrap_or_default(),
            },
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.9.0-rc.33")
