...
// alef:hash:6bccce3274fbcda973df36f47c87ed7fed43e116a6dc12f0badb027146133284
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.19.1")
