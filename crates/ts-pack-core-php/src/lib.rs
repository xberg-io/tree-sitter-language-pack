...
// alef:hash:e0a1fc3097d36f155dc956e33e3b0c81facfd1f80962b418a500898582941da3
...
impl PackConfig {
     ...
     * @throws TreeSitterLanguagePackException Returns an error if the file cannot be read or the TOML is invalid.
     *
     * ```php
     * use std::path::Path;
