...
// alef:hash:dd1fc55966819f3193e56b81052adaa5b13593a376f10b5f9a92adbff682ee1d
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.19.0")
