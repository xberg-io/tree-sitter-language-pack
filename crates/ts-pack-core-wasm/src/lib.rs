...
// alef:hash:5f8cdf239d6329676ec0ed7f4ff3624abe8fbc106657146799c7d8b6eb1198f5
    ...
    pub fn new(
        ...
        WasmCommentInfo {
            ...
            kind: kind.unwrap_or_else(|| {
                <tree_sitter_language_pack::CommentInfo as ::core::default::Default>::default()
                    .kind
                    .into()
            }),
...
impl WasmDataNode {
    ...
    pub fn new(
        ...
        WasmDataNode {
            kind: kind.unwrap_or_else(|| {
                <tree_sitter_language_pack::DataNode as ::core::default::Default>::default()
                    .kind
                    .into()
            }),
            key,
...
impl WasmDiagnostic {
    ...
    pub fn new(
        ...
        WasmDiagnostic {
            ...
            severity: severity.unwrap_or_else(|| {
                <tree_sitter_language_pack::Diagnostic as ::core::default::Default>::default()
                    .severity
                    .into()
            }),
            span: span.unwrap_or_default(),
...
impl WasmDocstringInfo {
        ...
        WasmDocstringInfo {
            ...
            format: format.unwrap_or_else(|| {
                serde_wasm_bindgen::to_value(
                    &<tree_sitter_language_pack::DocstringInfo as ::core::default::Default>::default().format,
                )
    ...
    #[wasm_bindgen(setter)]
    pub fn set_format(&mut self, value: JsValue) {
        self.format = value;
    }
...
impl WasmExportInfo {
    ...
    pub fn new(name: Option<String>, kind: Option<WasmExportKind>, span: Option<WasmSpan>) -> WasmExportInfo {
        WasmExportInfo {
            name: name.unwrap_or_default(),
            kind: kind.unwrap_or_else(|| {
                <tree_sitter_language_pack::ExportInfo as ::core::default::Default>::default()
                    .kind
                    .into()
            }),
            span: span.unwrap_or_default(),
...
impl WasmParser {
    ...
    #[wasm_bindgen(js_name = "setMaxSourceBytes")]
    pub fn set_max_source_bytes(&self, max_bytes: Option<usize>) -> () {
    ...
    #[wasm_bindgen(js_name = "setParseTimeoutMs")]
    pub fn set_parse_timeout_ms(&self, timeout_ms: Option<u64>) -> () {
...
impl WasmProcessConfig {
    ...
    pub fn new(
        ...
        maxSourceBytes: Option<usize>,
        parseTimeoutMs: Option<u64>,
    ) -> WasmProcessConfig {
        WasmProcessConfig {
            language: language.unwrap_or_else(|| "".to_string()),
    ...
    #[wasm_bindgen(getter, js_name = "maxSourceBytes")]
    pub fn max_source_bytes(&self) -> Option<usize> {
        self.max_source_bytes
    }

    #[wasm_bindgen(setter, js_name = "maxSourceBytes")]
    pub fn set_max_source_bytes(&mut self, value: Option<usize>) {
        self.max_source_bytes = value;
    }

    #[wasm_bindgen(getter, js_name = "parseTimeoutMs")]
    pub fn parse_timeout_ms(&self) -> Option<u64> {
        self.parse_timeout_ms
    }

    #[wasm_bindgen(setter, js_name = "parseTimeoutMs")]
    pub fn set_parse_timeout_ms(&mut self, value: Option<u64>) {
        self.parse_timeout_ms = value;
    }
    ...
    #[wasm_bindgen(js_name = "withMaxSourceBytes")]
    pub fn with_max_source_bytes(&self, max_bytes: Option<usize>) -> WasmProcessConfig {
        tree_sitter_language_pack::ProcessConfig::from(self.clone())
    ...
    #[wasm_bindgen(js_name = "withParseTimeoutMs")]
    pub fn with_parse_timeout_ms(&self, timeout_ms: Option<u64>) -> WasmProcessConfig {
        tree_sitter_language_pack::ProcessConfig::from(self.clone())
    ...
    pub fn validate(&self) -> Result<(), JsValue> {
        let result = tree_sitter_language_pack::ProcessConfig::from(self.clone())
            .validate()
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
        Ok(result)
    }
...
impl WasmStructureItem {
    ...
    pub fn new(
        ...
        WasmStructureItem {
            kind: kind.unwrap_or_else(|| {
                serde_wasm_bindgen::to_value(
                    &<tree_sitter_language_pack::StructureItem as ::core::default::Default>::default().kind,
                )
                .unwrap_or(wasm_bindgen::JsValue::NULL)
            }),
            name,
...
impl WasmSymbolInfo {
    ...
    pub fn new(
        ...
        WasmSymbolInfo {
            ...
            kind: kind.unwrap_or_else(|| {
                serde_wasm_bindgen::to_value(
                    &<tree_sitter_language_pack::SymbolInfo as ::core::default::Default>::default().kind,
                )
                .unwrap_or(wasm_bindgen::JsValue::NULL)
            }),
            span: span.unwrap_or_default(),
...
#[wasm_bindgen]
#[derive(Clone, Default)]
pub struct WasmDocstringFormat {
...
impl WasmDocstringFormat {
    #[wasm_bindgen(constructor)]
    pub fn new() -> WasmDocstringFormat {
        Self::default()
    }

    #[wasm_bindgen]
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> WasmDocstringFormat {
...
impl WasmStructureKind {
    #[wasm_bindgen(constructor)]
    pub fn new() -> WasmStructureKind {
        Self::default()
    }

    #[wasm_bindgen]
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> WasmStructureKind {
        <Self as ::core::default::Default>::default()
    }
...
impl WasmSymbolKind {
    #[wasm_bindgen(constructor)]
    pub fn new() -> WasmSymbolKind {
        Self::default()
    }

    #[wasm_bindgen]
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> WasmSymbolKind {
        <Self as ::core::default::Default>::default()
    }
...
pub struct ProcessConfigInput {
    ...
    #[serde(rename = "maxSourceBytes")]
    pub max_source_bytes: Option<usize>,
    #[serde(rename = "parseTimeoutMs")]
...
impl From<ProcessConfigInput> for tree_sitter_language_pack::ProcessConfig {
    fn from(val: ProcessConfigInput) -> Self {
        ...
        if let Some(v) = val.max_source_bytes {
            out.max_source_bytes = v.into();
        }
        if let Some(v) = val.parse_timeout_ms {
            out.parse_timeout_ms = v.into();
        }
        out
    }
}
...
pub fn prefetch(languages: Vec<String>) -> Result<(), JsValue> {
    ...
    let result = tree_sitter_language_pack::prefetch(&languages_refs).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
#[allow(clippy::missing_errors_doc)]
#[wasm_bindgen]
pub fn process(source: String, config: WasmProcessConfig) -> Result<WasmProcessResult, JsValue> {
...
impl From<WasmDocstringInfo> for tree_sitter_language_pack::DocstringInfo {
    fn from(val: WasmDocstringInfo) -> Self {
        Self {
            text: val.text,
            format: serde_wasm_bindgen::from_value(val.format.clone()).unwrap_or_default(),
            span: val.span.into(),
...
impl From<tree_sitter_language_pack::DocstringInfo> for WasmDocstringInfo {
    fn from(val: tree_sitter_language_pack::DocstringInfo) -> Self {
        Self {
            text: val.text.to_string(),
            format: serde_wasm_bindgen::to_value(&val.format).unwrap_or(JsValue::NULL),
            span: val.span.into(),
...
impl From<WasmDocstringFormat> for tree_sitter_language_pack::DocstringFormat {
    fn from(val: WasmDocstringFormat) -> Self {
        match val.r#type.as_str() {
            ...
            "Other" => Self::Other(val._0.clone().unwrap_or_default()),
...
impl From<tree_sitter_language_pack::DocstringFormat> for WasmDocstringFormat {
    fn from(val: tree_sitter_language_pack::DocstringFormat) -> Self {
        match val {
            ...
            tree_sitter_language_pack::DocstringFormat::Other(field0) => Self {
...
impl From<tree_sitter_language_pack::StructureKind> for WasmStructureKind {
    fn from(val: tree_sitter_language_pack::StructureKind) -> Self {
        match val {
            ...
            tree_sitter_language_pack::StructureKind::Other(field0) => Self {
                r#type: "Other".to_string(),
                _0: Some(field0),
            },
            _ => Self::default(),
...
impl From<tree_sitter_language_pack::SymbolKind> for WasmSymbolKind {
    fn from(val: tree_sitter_language_pack::SymbolKind) -> Self {
        match val {
            ...
            tree_sitter_language_pack::SymbolKind::Other(field0) => Self {
                r#type: "Other".to_string(),
                _0: Some(field0),
            },
            _ => Self::default(),
...
fn error_error_code(e: &tree_sitter_language_pack::error::Error) -> &'static str {
    ...
    match e {
        ...
        tree_sitter_language_pack::error::Error::ParseTimeout { .. } => "parse_timeout",
