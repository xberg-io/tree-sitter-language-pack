...
impl From<tree_sitter_language_pack::StructureKind> for WasmStructureKind {
    fn from(val: tree_sitter_language_pack::StructureKind) -> Self {
        match val {
            ...
            tree_sitter_language_pack::StructureKind::Other { value } => Self {
                kind: "Other".to_string(),
                value: Some(value),
            },
            _ => ::std::todo!("unmapped StructureKind variant"),
        }
    }
}
    ...
    fn from(val: tree_sitter_language_pack::DocstringFormat) -> Self {
        match val {
            tree_sitter_language_pack::DocstringFormat::PythonTripleQuote => Self {
                kind: "PythonTripleQuote".to_string(),
                value: None,
            },
            tree_sitter_language_pack::DocstringFormat::JSDoc => Self {
                kind: "JSDoc".to_string(),
                value: None,
            },
            tree_sitter_language_pack::DocstringFormat::Rustdoc => Self {
                kind: "Rustdoc".to_string(),
                value: None,
            },
            tree_sitter_language_pack::DocstringFormat::GoDoc => Self {
                kind: "GoDoc".to_string(),
                value: None,
            },
            tree_sitter_language_pack::DocstringFormat::JavaDoc => Self {
                kind: "JavaDoc".to_string(),
                value: None,
            },
            tree_sitter_language_pack::DocstringFormat::Other { value } => Self {
                kind: "Other".to_string(),
                value: Some(value),
            },
            _ => ::std::todo!("unmapped DocstringFormat variant"),
        }
    }
}
...
impl From<tree_sitter_language_pack::SymbolKind> for WasmSymbolKind {
    fn from(val: tree_sitter_language_pack::SymbolKind) -> Self {
        match val {
            ...
            tree_sitter_language_pack::SymbolKind::Other { value } => Self {
                kind: "Other".to_string(),
                value: Some(value),
            },
            _ => ::std::todo!("unmapped SymbolKind variant"),
        }
    }
}
