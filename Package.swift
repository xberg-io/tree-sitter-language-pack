...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/tree-sitter-language-pack/releases/download/v1.9.0-rc.29/TreeSitterLanguagePack-rs.artifactbundle.zip",
      checksum: "53249f9cfd6daad837beac314d0b31adfe31a2fa16ef25437f7096358c42054b"
    ),
